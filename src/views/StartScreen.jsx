  ...
  return (
    <section className="absolute inset-0 flex animate-[screenIn_0.45s_ease-out_both] flex-col justify-center overflow-x-hidden overflow-y-auto py-[110px]">
      ...
      <button
        ...
        className="absolute bottom-10 left-1/2 z-10 flex h-11 w-11 -translate-x-1/2 items-center justify-center animate-[bob_2.2s_ease-in-out_infinite] cursor-pointer rounded-full border-none bg-transparent text-lg font-bold text-text-primary shadow-[inset_0_0_0_2.5px_var(--border-primary)] md:h-12 md:w-12"
      >
        ↓
      </button>
    </section>
